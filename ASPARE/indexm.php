            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        <h1>ASPARE</h1>
                        <p>Welcome to the ASPARE portal which helps you to easily acheive the criteria based outcome with ease based on your Institution standards.Know more about NBA ?</p>
